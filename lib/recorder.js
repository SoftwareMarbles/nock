...
var normalizeRequestOptions = require('./common').normalizeRequestOptions;
...
function generateRequestAndResponseObject(req, body, options, res, datas) {
...
function generateRequestAndResponse(req, body, options, res, datas) {
  ...
  [http, https].forEach(function(module) {
    ...
    req = oldRequest.call(http, options, function(res) {
      ...
      res.once('end', function() {
        var out;
        if(output_objects) {
          out = generateRequestAndResponseObject(req, body, options, res, datas);
        } else {
          out = generateRequestAndResponse(req, body, options, res, datas);
        }
