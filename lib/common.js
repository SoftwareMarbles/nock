...
//  Array where all information about all the overriden requests are held.
var requestOverride = [];
...
var overrideRequests = function(newRequest) {
  ...
  ['http', 'https'].forEach(function(proto) {
    ...
    var moduleName = proto, // 1 to 1 match of protocol and module is fortunate :)
        ...
        overridenRequest = module.request;

    if(requestOverride[moduleName]) {
      throw new Error('Module\'s request already overriden for ' + moduleName + ' protocol.');
    }

    requestOverride[moduleName] = {
      module: module,
      request: overridenRequest
    };

    module.request = function(options, callback) {
      return newRequest(proto, overridenRequest.bind(module), options, callback);
    };
  });
};

var restoreOverridenRequests = function() {
...
exports.restoreOverridenRequests = restoreOverridenRequests;
